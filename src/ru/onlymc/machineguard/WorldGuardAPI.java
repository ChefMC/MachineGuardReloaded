...
public class WorldGuardAPI {
    ...
    @Nullable
    public ApplicableRegionSet getRegionsAt(Location location) {
    ...
    public boolean isPVPAllowed(Player player, Location location) {
        ...
        ApplicableRegionSet checkSet = getRegionsAt(location);
    ...
    /*public boolean hasBuildPermission(Player player, Block block) {
    	return hasBuildPermission(player, block.getLocation());
    }*/

    public boolean canBuild(Player player, Location location) {
        initialize();
        if (location != null && createQueryMethod != null && regionContainer != null) {
            try {
                boolean result;
                ...
                if (locationAdaptMethod != null) {
                    ...
                    result = (boolean)regionQueryTestStateMethod.invoke(query, loc, getAssociable(player), new StateFlag[]{buildFlag});
                } else {
